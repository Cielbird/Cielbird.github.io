...
This is pretty simple but tedious code to write. Each possible 6 faces have a separate case. 
...
buffers outside my engine code!
...
Collision is a really heavy task, especially when it needs to be done 60 times a 
second. Some questions you need to ask to have faster collision :
...
If I have a 3x3x3 solid block of voxels, I can have one AABB collider instead of 27. For example:
...
The problem to finding the true minimum number of boxes for a given voxel grid is NP-hard. 
But we can use a good greedy solution to get reasonable performance gains.
